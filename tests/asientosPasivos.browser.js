...
async function main() {
  ...
  app.get("/compras/facturas/asientos", async (_req, res) => {
    const html = await ejs.renderFile(path.join(__dirname, "../src/views/compras/asientos_pasivos.ejs"), {
      ...
      facturas: [
        { id: 1, tipo: "orden", fecha: new Date("2026-09-22T12:00:00Z"), po_numero: "2026-100", numero_factura: "001001", proveedor_nombre: "Proveedor Uno", placa_recepcion: "C164528", monto: 1250, nota_credito_monto: 0 },
