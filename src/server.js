...
const aresepRoutes = require("./routes/aresep.routes");
const comprasRoutes = require("./routes/compras.routes");
const facturasCorreoRoutes = require("./routes/facturasCorreo.routes");
...
app.use("/lavado-unidades", lavadoUnidadesRoutes);
